...
from .core.material_filters import FiltersMaterialChannelToggles, MATLAY_material_filter_stack, MATLAY_UL_layer_filter_stack, MATLAY_material_filters, MATLAY_OT_add_layer_filter_menu, MATLAY_OT_add_layer_filter_rgb_curves, MATLAY_OT_add_layer_filter_hsv, MATLAY_OT_add_layer_filter_invert, MATLAY_OT_add_layer_filter_val_to_rgb, MATLAY_OT_add_layer_filter_bright_contrast, MATLAY_OT_add_material_filter_normal_intensity, MATLAY_OT_delete_layer_filter, MATLAY_OT_move_layer_filter_up, MATLAY_OT_move_layer_filter_down
...
classes = (
    ...
    MATLAY_OT_add_material_filter_normal_intensity,
